        ...
        for STD in standardDeviation:
            for SplRat in splitratio:
                for Nois in noise:
                    ...
                    '''
                    middle = w.size + ReverseSplitRatioMDataA* (1/feat)
                   ...
                   # print(objective)
                    ...
                    df2 = pd.DataFrame({'Training': int(SplRat*100),
                                        ...
                                        "Features":feat,},index =[0])
                    
                    df4 = pd.concat([df4, df2])
                    #df4 = pd.concat([df4, df2])
                
df4.to_csv(path_or_buf='testResult/feat1.csv')
